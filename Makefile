...
HEADERS = byte_operations.hpp input_handler.hpp instructions.hpp output_handler.hpp parser.hpp symbol_table.hpp
# Program name
PROGRAM = disassem
...
symbol_table.o : symbol_table.hpp symbol_table.cpp
	$(CXX) $(CXXFLAGS) $(INCLUDE) symbol_table.cpp
